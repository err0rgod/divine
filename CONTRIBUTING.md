...
Thanks for helping improve Divine Gateway. Keep changes focused, test the behavior you change, and preserve the public Claude Code and Codex workflows.
...
- Keep shared Anthropic protocol behavior under `src/divine/core/anthropic/` rather than importing utilities from another provider.
