...
PROVIDERS = {
    ...
    "bluesmind": {
        "url": "https://api.bluesmind.ai/v1/chat/completions",
        "key_name": "Bluesmind",
    },
    "agentrouter": {
        "url": "https://api.agentrouter.ai/v1/chat/completions",
        "key_name": "AgentRouter",
    },
}
...
class MasterProxyHandler(http.server.BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        try:
            ...
            print(
                f"[Master Proxy] Routing to {provider_id.upper()} using model {target_model}"
            )
