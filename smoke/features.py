...
FEATURE_INVENTORY: tuple[FeatureCoverage, ...] = (
    FeatureCoverage(
        ...
        "missing providers are missing_env unless Divine_ALLOW_NO_PROVIDER_SMOKE=1",
    ),
    FeatureCoverage(
        "drop_in_claude_code_replacement",
        ...
        (
            "configured provider",
            "Divine_SMOKE_CLAUDE_BIN for real Claude CLI",
            "NVIDIA_NIM_API_KEY",
            "OPENROUTER_API_KEY",
        ),
    ...
    FeatureCoverage(
        "pi_cli_integration",
        "Pi discovers Divine models and sends Anthropic Messages through the proxy",
        "readme",
        ("tests/cli/test_entrypoints.py",),
        ("test_probe_and_models_routes",),
    ...
    FeatureCoverage(
        ...
        ("providers",),
        ("configured provider credentials/endpoints", "optional Divine_SMOKE_MODEL_*"),
    ...
    FeatureCoverage(
        ...
        ("messaging", "voice"),
        ("VOICE_NOTE_ENABLED", "Divine_SMOKE_RUN_VOICE", "WHISPER_DEVICE"),
    ...
    FeatureCoverage(
        ...
        "Divine_ENV_FILE, dotenv, and process env precedence are deterministic",
        "public_surface",
