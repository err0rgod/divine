...
CAPABILITY_CONTRACTS: tuple[CapabilityContract, ...] = (
    ...
    CapabilityContract(
        ...
        "divine.api.handlers.messages.MessagesHandler",
    ...
    CapabilityContract(
        ...
        "divine.api.handlers.responses.ResponsesHandler",
    ...
    CapabilityContract(
        ...
        "divine.api.dependencies.require_proxy_auth",
    ...
    CapabilityContract(
        ...
        "provider_runtime",
        "provider_matrix",
        "divine.runtime.provider_manager.ProviderRuntimeManager",
    ...
    CapabilityContract(
        ...
        "per_model_mapping",
        "divine.application.routing.ModelRouter",
    ...
    CapabilityContract(
        ...
        "divine.providers.runtime.ProviderRuntime",
    ...
    CapabilityContract(
        ...
        "divine.core.failures.ExecutionFailure",
    ...
    CapabilityContract(
        ...
        "divine.core.anthropic.thinking",
    ...
    CapabilityContract(
        ...
        "subagent_control",
        "divine.core.anthropic.streaming.AnthropicStreamLedger",
    ...
    CapabilityContract(
        ...
        "divine.api.optimization_handlers",
    ...
    CapabilityContract(
        ...
        "divine.core.anthropic.get_token_count",
    ...
    CapabilityContract(
        ...
        "smart_rate_limiting",
        "divine.providers.rate_limit.ProviderRateLimiter",
    ...
    CapabilityContract(
        ...
        "lmstudio_messages",
        "lmstudio_endpoint",
        "divine.providers.lmstudio.LMStudioProvider",
    ...
    CapabilityContract(
        ...
        "llamacpp_endpoint",
        "divine.providers.openai_chat.OpenAIChatProvider",
    ...
    CapabilityContract(
        ...
        "provider_matrix",
        "divine.providers.open_router.OpenRouterProvider",
    ...
    CapabilityContract(
        ...
        "divine.messaging.workflow.MessagingWorkflow",
    ...
    CapabilityContract(
        ...
        "tree_threading",
        "tree_threading",
        "divine.messaging.trees.TreeQueueManager",
    ...
    CapabilityContract(
        ...
        "restart_restore",
        "restart_restore",
        "divine.messaging.session.SessionStore",
        "stored tree JSON",
    ...
    CapabilityContract(
        ...
        "voice_transcription",
        "voice_notes",
        "divine.messaging.voice.Transcriber",
    ...
    CapabilityContract(
        ...
        (
            "test_divine_init_scaffolds_user_config",
            "test_divine_entrypoint_starts_server",
    ...
    CapabilityContract(
        ...
        "claude_cli_drop_in",
        "claude_cli_drop_in",
        "divine.cli.managed.session.ManagedClaudeSession",
    ...
    CapabilityContract(
        ...
        "pi_cli_integration",
        "pi_cli_integration",
        "divine.cli.launchers.pi",
        "Pi CLI binary, bundled extension, and Divine child-process environment",
        "Anthropic Messages provider with an Divine-scoped live model catalog",
    ...
    CapabilityContract(
        ...
        "divine.providers.runtime and divine.messaging.platforms.factory",
