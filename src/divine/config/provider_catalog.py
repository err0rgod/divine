...
FORGE_AI_DEFAULT_BASE = "https://forge-gateway-api.fly.dev/v1"
...
PROVIDER_CATALOG: dict[str, ProviderDescriptor] = {
    ...
    "forge_ai": ProviderDescriptor(
        provider_id="forge_ai",
        display_name="Forge AI",
        credential_env="FORGE_AI_API_KEY",
        credential_url="https://forge-gateway-api.fly.dev",
        credential_attr="forge_ai_api_key",
        default_base_url=FORGE_AI_DEFAULT_BASE,
    ),
