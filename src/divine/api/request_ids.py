...
from divine.core.trace import extract_claude_session_id_from_headers

REQUEST_ID_HEADER = "request-id"
OPENAI_REQUEST_ID_HEADER = "x-request-id"
_REQUEST_ID_STATE_ATTRIBUTE = "divine_request_id"
...
def new_request_id() -> str:
    """Return a new opaque Divine request identifier."""
