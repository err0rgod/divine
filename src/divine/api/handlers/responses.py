...
from divine.application.execution import ProviderExecutor
...
from divine.core.anthropic import MessagesRequest
    ...
    async def create(
        ...
        if request_data.stream is False:
            raise InvalidRequestError(
                "Divine /v1/responses supports streaming only; omit stream or set stream=true."
            )
