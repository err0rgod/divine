...
from divine.api.detection import is_safety_classifier_request
from divine.api.optimization_handlers import try_optimizations
...
from divine.api.response_streams import (
    EmptyStreamError,
...
from divine.api.web_tools.request import (
    is_web_server_tool_request,
    unsupported_server_tool_error,
)
from divine.api.web_tools.streaming import stream_web_server_tool_response
from divine.application.errors import ApplicationError, InvalidRequestError
from divine.application.execution import ProviderExecutor, TokenCounter
from divine.application.ports import ProviderResolver
from divine.application.routing import ModelRouter, RoutedMessagesRequest
...
from divine.core.failures import ExecutionFailure, find_execution_failure
...
class MessagesHandler:
    ...
    def _apply_message_routing_policies(
        ...
        trace_event(
            stage="routing",
            event="divine.api.optimization.safety_classifier_no_thinking",
            source="api",
    ...
    def _intercept_web_server_tool(
        ...
        trace_event(
            stage="routing",
            event="divine.api.optimization.web_server_tool",
            source="api",
            model=routed.request.model,
        )
    ...
    def _intercept_local_optimization(
        ...
        trace_event(
            stage="routing",
            event="divine.api.optimization.short_circuit",
            source="api",
            model=routed.request.model,
        )
