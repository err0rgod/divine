...
from divine.core.anthropic import anthropic_error_type_for_failure
...
from divine.core.async_iterators import try_close_async_iterator
from divine.core.diagnostics import safe_exception_message
from divine.core.failures import find_execution_failure
from divine.core.trace import close_stream_input, trace_event
...
def _trace_response_cleanup_failure(operation: str, exc: BaseException) -> None:
    trace_event(
        stage="egress",
        event="divine.api.response.cleanup_failed",
        source="api",
        operation=operation,
...
def trace_terminal_execution_error(
    *,
    ...
    fields: dict[str, object] = {
        "stage": "egress",
        "event": "divine.api.response.terminal_execution_error",
        "source": "api",
        "wire_api": wire_api,
