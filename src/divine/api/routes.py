...
from divine.application.ports import ProviderResolver, RequestRuntimeLease
...
async def list_models(
    ...
    trace_event(stage="ingress", event="divine.api.models.list", source="api")
...
async def stop_cli(
    ...
    trace_event(
        stage="ingress",
        event="divine.api.cli.stop_via_messaging_workflow",
        source="api",
