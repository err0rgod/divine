"""Single production composition root for the Divine server."""

import os
from pathlib import Path

from divine.api.app import create_app
from divine.api.ports import ApiServices
from divine.config.logging_config import configure_logging
