    ...
    def stream(
        ...
        *,
        ...
        trace_event(
            stage="ingress",
            event=(
                "divine.api.responses.request.received"
                if wire_api == "responses"
                else "divine.api.request.received"
            ),
            source="api",
        ...
        return traced_async_stream(
            ...
            source="api",
            complete_event=(
                "divine.api.responses.stream_completed"
                if wire_api == "responses"
                else "divine.api.response.stream_completed"
            ),
            interrupted_event=(
                "divine.api.responses.stream_interrupted"
                if wire_api == "responses"
                else "divine.api.response.stream_interrupted"
            ),
            chunk_event=None,
            extra=stream_trace,
        )
