...
from divine.api import request_errors
from divine.api.handlers import MessagesHandler, TokenCountHandler
from divine.application import execution
...
def test_parse_cli_event_error_logs_metadata_by_default():
    ...
    with patch("divine.messaging.event_parser.logger.info") as log_info:
        parse_cli_event(
...
def test_count_tokens_unexpected_error_default_logs_exclude_exception_text():
    ...
    from divine.core.anthropic.models import TokenCountRequest
