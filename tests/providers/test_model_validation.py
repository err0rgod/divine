...
from divine.application.model_metadata import ProviderModelInfo
from divine.config.nim import NimSettings
from divine.config.provider_catalog import (
...
from divine.providers.base import BaseProvider, ProviderConfig
from divine.providers.deepseek import DeepSeekProvider
from divine.providers.model_listing import ModelListResponseError
...
from divine.providers.runtime.model_cache import ProviderModelCache
...
async def test_nim_lists_openai_compatible_model_ids() -> None:
    ...
    with patch("divine.providers.openai_chat.provider.AsyncOpenAI"):
