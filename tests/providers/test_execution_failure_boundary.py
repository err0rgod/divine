...
from divine.providers.http import close_provider_stream
...
async def test_openai_stream_close_failure_cannot_mask_execution_failure() -> None:
    ...
    with (
        ...
        patch("divine.providers.http.trace_event") as trace_event,
        pytest.raises(ExecutionFailure) as exc_info,
    ):
        [
            event
...
async def test_stream_close_failure_without_active_error_is_observability_only() -> (
    ...
    with patch("divine.providers.http.trace_event") as trace_event:
