...
from divine.config.provider_catalog import HUGGINGFACE_DEFAULT_BASE
from divine.core.anthropic import ReasoningReplayMode
...
def test_build_request_body_keeps_max_tokens(huggingface_provider):
    with patch(
        "divine.providers.openai_chat.request_policy.build_base_request_body"
    ) as mock_convert:
