...
from divine.providers.openai_chat.provider import (
    _OpenAIChatStreamRunner,
)
from divine.providers.openai_chat.tool_calls import (
...
class TestProcessToolCall:
    ...
    def test_heuristic_tool_use_sse_marks_committed_tool_output(self):
        ...
        from divine.core.anthropic import AnthropicStreamLedger
