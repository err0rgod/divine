...
from divine.config.constants import (
...
from divine.config.model_refs import (
...
class TestSettings:
    ...
    def test_default_claude_workspace_uses_divine_home(self, monkeypatch, tmp_path):
    ...
    def test_server_log_path_uses_divine_home(self, monkeypatch, tmp_path):
        """The server log location is fixed under ~/.fcc."""
        from divine.config.paths import server_log_path
    ...
    def test_blank_claude_workspace_uses_divine_home(self, monkeypatch, tmp_path):
    ...
    def test_get_settings_cached(self):
        ...
        from divine.config.settings import get_settings
    ...
    def test_base_url_constant(self):
        ...
        from divine.config.provider_catalog import NVIDIA_NIM_DEFAULT_BASE
