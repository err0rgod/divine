...
from divine.messaging.platforms.discord import (
    DISCORD_AVAILABLE,
    DiscordRuntime,
    _get_discord,
)
from divine.messaging.platforms.discord_inbound import (
    discord_text_message_from_event,
    parse_allowed_channels,
)
from divine.messaging.platforms.discord_io import truncate_discord_message
...
class TestGetDiscord:
    ...
    def test_raises_when_discord_not_available(self):
        import divine.messaging.platforms.discord as discord_mod
