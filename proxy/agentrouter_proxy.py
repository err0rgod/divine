...
class AgentRouterProxyHandler(http.server.BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        try:
            ...
            print(f"[AgentRouter Proxy] Translated request (Target Model: {DEFAULT_TARGET_MODEL})")
            ...
            for key in AGENTROUTER_API_KEYS:
                ...
                try:
                    ...
                    if e.code == 429:
                        ...
                        error_body = e.read()
                        print(f"[AgentRouter Proxy Error] HTTP {e.code}: {error_body.decode('utf-8', errors='ignore')}")
